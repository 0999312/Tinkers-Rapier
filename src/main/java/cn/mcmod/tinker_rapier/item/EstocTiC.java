...
public class EstocTiC extends ModifiableSwordItem {
    ...
    public static final ToolDefinition ESTOC = ToolDefinition
            .builder(TiCItemRegistry.ESTOC)
            .meleeHarvest()
            .build();

    public EstocTiC() {
        super(RapierMain.defaultItemProperties(), ESTOC);
    }
    ...
    public boolean onLeftClickEntity(ItemStack stack, Player player, Entity entity) {
        ...
        RapierUtil.DoStingAttack(stack, (baseDamage * 0.5F), calculateExtraDamage(baseDamage, ToolStack.from(stack), player, target), player, target, true);
        return super.onLeftClickEntity(stack, player, entity);
    }
